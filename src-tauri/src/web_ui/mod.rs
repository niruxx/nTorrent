...
fn build_router(state: WebState) -> Router {
    let api_router = Router::new()
        ...
        .route("/torrents/{id}/peers", get(handlers::get_torrent_peers))
        .route("/torrents/create", post(handlers::create_torrent))
        .route("/stats", get(handlers::get_session_stats))
        .route("/system/disk-space", get(handlers::get_disk_space))
        .route("/trackers/favicon", get(handlers::get_tracker_favicon))
